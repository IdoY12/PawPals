...
const dogOwners = [
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9857, 40.7484] as [number, number], // NYC - Times Square area
  ...
  },
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9712, 40.7831] as [number, number], // NYC - Upper West Side
  ...
  },
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9654, 40.7829] as [number, number], // NYC - Central Park area
  ...
  },
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9442, 40.6782] as [number, number], // Brooklyn
  ...
  },
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9519, 40.7681] as [number, number], // NYC - Upper East Side
...
const dogSitters = [
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9866, 40.7488] as [number, number], // NYC - Near Times Square
  ...
  },
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9747, 40.7614] as [number, number], // NYC - Midtown
  ...
  },
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9876, 40.7558] as [number, number], // NYC - Hell's Kitchen
  ...
  },
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9632, 40.7794] as [number, number], // NYC - Upper West
  ...
  },
  {
    ...
    location: {
      type: 'Point' as const,
      coordinates: [-73.9557, 40.7705] as [number, number], // NYC - East Side
